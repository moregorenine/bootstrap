        ...
        return (
            ...
            <header className="navbar navbar-expand-md navbar-dark bg-primary">
                <nav className="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
                    ...
                    <a className="navbar-brand p-0 me-5" href="/" aria-label="Bootstrap">moregorenine</a>
                    <button className="navbar-toggler" type="button" data-bs-toggle="collapse"
                            data-bs-target="#bdNavbar" aria-controls="bdNavbar" aria-expanded="true"
                            aria-label="Toggle navigation">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" className="bi"
                             fill="currentColor" viewBox="0 0 16 16">
                            <path fillRule="evenodd"
                                  d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"></path>
                        </svg>
                    </button>
                    <div className="navbar-collapse collapse show" id="bdNavbar">
                        <ul className="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
                            <li className="nav-item col-6 col-md-auto">
                                <a className="nav-link p-2" href="/">Home</a>
                            </li>
                            <li className="nav-item col-6 col-md-auto">
                                <a className="nav-link p-2 active" href="#">Docs</a>
                            </li>
                            <li className="nav-item col-6 col-md-auto">
                                <a className="nav-link p-2" href="#">Examples</a>
                            </li>
                            <li className="nav-item col-6 col-md-auto">
                                <a className="nav-link p-2" href="#">Icons</a>
                            </li>
                            <li className="nav-item col-6 col-md-auto">
                                <a className="nav-link p-2" href="">Themes</a>
                            </li>
                            <li className="nav-item col-6 col-md-auto">
                        ...
                        <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
                            <li className="nav-item col-6 col-md-auto">
                                <a className="nav-link p-2" href="https://github.com/moregorenine" target="_blank"
                                   rel="noopener">
                            ...
                            <li className="nav-item col-6 col-md-auto">
                                <a className="nav-link p-2" href="https://twitter.com/w4springrain" target="_blank"
                                   rel="noopener">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                         className="navbar-nav-svg d-inline-block align-text-top"
